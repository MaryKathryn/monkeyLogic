% Note: This file is included in the NIMH ML 2 package to read the old
% data file (*.bhv) and doesn't work with the new formats (*.bhv2, *.h5).
% Please use mlread.m to read the new formats. -Jaewon Hwang
